window.onload = function () {
  ...
  //  function moveDuck (object) {

  //    document.querySelector('.duck').style.transition = " Math.random() * window.innerWidth "
  ...
  function createDuck() {
    ...
    newDiv.addEventListener ('click', function() { newDiv.classList.add ('shot')
      ...
      setTimeout(function(){ newDiv.remove(); checkForWinner()}, 1000)
...
const nDucks = document.querySelectorAll('.duck')
  if ( nDucks.length === 0) {
        alert ( 'YOU WON!')
  } 
